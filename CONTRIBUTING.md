...
Thank you for your interest in contributing to **Enkinex ODPS**, the [KCL](https://www.kcl-lang.io/) Library for the
[Open Data Product Standard (ODPS)](https://github.com/bitol-io/open-data-product-standard). This guide covers
...
The library is organized as one KCL module per section of related ODPS definitions, mirroring the standard JSON schema
...
- [`history.md`](history.md) — which standard ODPS version this library tracks.
